...
const AddPatient = () => {
  ...
  return (
    ...
    <Link to='/dashboard'>
        <button className='bg-blue-500 text-sm font-bold hover:bg-blue-700 text-white rounded-xl px-4 py-2 mb-4'>&lt; رجوع</button>
    </Link>
    <form className='mb-5' onSubmit={handleSubmit}>   
      ...
      <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only">ابحث عن مريض</label>
      <div className="relative">
        ...
        <input 
          ...
          placeholder="أضف المريض عبر البريد الإلكتروني..." 
          required 
